...
class ViewHolder_LP extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        MenuItem viewGrades = menu.add(0, v.getId(), 0, R.string.menu_lecturer_view_grades);
        viewGrades.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
